                                ...
                                <div class="lists_teachers p-4">
                                    <div class="row text_black">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="author_profile_pic">
                                                <img class="w-100" src="./assets/images/student2.png" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                            <div class="row">
                                                <div class="text_main ps-2">
                                                    ...
                                                    <h6 class="card-subtitle mb-2 fs-13">Student</h6>

                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="card_body_text fs-12">
                                                    <span class="mdi mdi-account-school text_primary_org pe-1"></span>
                                                    <span class="fw-bold pe-1">12</span>
                                                    <span class="text_black">enrolled</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="row">
                                                <div class="btn_edit">
                                                    <a href="./addstudent.php" class="btn_main float-end btn_secondary_org">
                                            ...
                                            <div class="row mt-2">
                                                <div class="card_body_text fs-12">
                                                    <span class="mdi mdi-shield-check text-success pe-2"></span>
                                                    <span class="text-black">Active</span>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="card_body_text fs-12">
                                                    <span class="mdi mdi-play-speed text_primary_org pe-1"></span>
                                                    <span class="fw-bold pe-1">8</span>
                                                    <span class="text-black">Course Completed</span>
                                                </div>
                                            </div>
                                            <div class="row mt-4">
                                                <div class="card_body_text fs-12">
                                                    <span class="fw-bold">Class 8th</span><br>
                                                    <span class="text-black">Oxford University, UAE</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="deactivating_btn d-flex gap-2">
                                            <div class="btn_deact">
                                                <button onclick="sweetAlert1(4)" type="button" class="btn_main2 btn-third">
